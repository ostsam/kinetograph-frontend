...
import { Phase, PaperEdit, PipelineError, TransitionType } from "./montazh";
...
export const PHASE_DESCRIPTIONS: Record<Phase, string> = {
	...
	[Phase.INGESTING]:
		"📦 Archivist is ingesting your footage — running speech-to-text & visual analysis...",
	[Phase.INDEXED]:
		"✅ Footage indexed! Master index built with transcripts & scene descriptions.",
	[Phase.SCRIPTING]:
		"✍️ Scripter is crafting your paper edit with Mistral AI...",
	[Phase.SCRIPTED]: "📝 Script complete! Paper edit generated.",
	[Phase.AWAITING_APPROVAL]:
		"⏸️ Ready for your review! Check the timeline below and approve or request changes.",
	[Phase.APPROVED]: "👍 Approved! Continuing pipeline...",
	[Phase.SYNTHESIZING]:
		"🎬 Synthesizer is sourcing B-roll from Pexels stock footage...",
	[Phase.SYNTHESIZED]: "✅ B-roll sourced and downloaded.",
	[Phase.NORMALIZING]:
		"🎞️ Director is normalizing clip formats for assembly...",
	...
	[Phase.MASTERING]:
		"🔊 Sound Engineer is mastering audio — music, levels, normalization...",
	[Phase.MASTERED]: "✅ Audio mastered.",
	[Phase.EXPORTING]: "📤 Exporting timeline files (FCPXML, OTIO)...",
	[Phase.COMPLETE]:
		"🎉 Your video is ready! It's been loaded into the timeline.",
